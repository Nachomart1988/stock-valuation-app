...
const PLANS = [
  {
    ...
    cta: 'Empezar gratis',
    ctaHref: '/register',
    ctaStyle: 'bg-gray-900/60 hover:bg-gray-900/50 text-white',
  },
  {
    key: 'pro',
    name: 'Pro',
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-black text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16 pt-20 sm:pt-24">
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-gray-900/80 rounded-full p-1.5 flex border border-green-900/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-16">
          {PLANS.map((plan) => (
            <div key={plan.key} className={`relative bg-gray-900/60 backdrop-blur rounded-2xl p-6 border-2 transition-all hover:scale-[1.02] ${plan.color}`}>
              {plan.badge && (
        ...
        <div className="mb-16">
          ...
          <div className="bg-gray-900/40 rounded-2xl border border-green-900/20 overflow-hidden">
        ...
        <div className="mb-16 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-gray-900/40 rounded-xl border border-green-900/20 overflow-hidden">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full p-5 text-left flex items-center justify-between hover:bg-gray-900/60/30 transition">
        ...
        {/* CTA */}
        <div className="text-center bg-gray-900/50 rounded-3xl p-8 sm:p-12 border border-emerald-500/20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register" className="px-8 py-3 bg-gray-900/60 hover:bg-gray-900/50 text-white font-bold rounded-xl transition">Empezar gratis</Link>

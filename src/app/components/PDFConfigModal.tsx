...
const SECTION_GROUPS: SectionGroup[] = [
  ...
  {
    label: 'Métricas & Calidad',
    color: 'text-cyan-400',
    sections: [
      { key: 'key_metrics',        label: 'Key Metrics Extendidas' },
      { key: 'dupont',             label: 'DuPont Analysis' },
      { key: 'quality_score',      label: 'Company Quality Score' },
      { key: 'enterprise_value',   label: 'Enterprise Value' },
      { key: 'owner_earnings',     label: 'Owner Earnings (Buffett)' },
    ],
  },
  {
    label: 'Costo de Capital & Crecimiento',
    color: 'text-teal-400',
    sections: [
      { key: 'beta_capm',          label: 'Beta & CAPM' },
      { key: 'wacc_cagr',          label: 'WACC & CAGR' },
      { key: 'sgr',                label: 'Sustainable Growth Rate' },
      { key: 'growth_analysis',    label: 'Growth Analysis (YoY)' },
    ],
  },
  {
    label: 'Valuación & Proyecciones',
    color: 'text-yellow-400',
    sections: [
      { key: 'valuation_models',   label: 'Modelos de Valuación' },
      { key: 'analyst_forecasts',  label: 'Forecasts de Analistas' },
      { key: 'revenue_forecast',   label: 'Revenue Forecast (Holt/Reg)' },
  ...
  },
  {
    ...
    sections: [
      { key: 'competitors',        label: 'Competidores (Peers)' },
      { key: 'industry_overview',  label: 'Industry & Sector' },
      { key: 'holders',            label: 'Holders (Inst. + Insider)' },
      { key: 'segmentation',       label: 'Revenue Segmentation' },

  ...
  return (
    <div className="space-y-10">
      ...
      {marketSummary.length > 0 && (
        <div className="bg-gradient-to-r from-black/50 to-black/40 p-6 rounded-xl border border-white/[0.08]">
          <h4 className="text-2xl font-bold text-gray-200 mb-6">{t('industryTab.majorIndices')}</h4>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {marketSummary.map((index, idx) => (
              <div key={idx} className="bg-black/60 p-4 rounded-lg border border-white/[0.06]">

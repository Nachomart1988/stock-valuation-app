    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/[0.06]">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right bg-gradient-to-r from-black to-sky-900/40 px-4 py-2 rounded-xl border border-green-600">
      ...
      {/* Input Controls */}
      <div className="bg-black/80 p-6 rounded-2xl border border-white/[0.08] shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-black/60 border-2 border-red-500/50 rounded-xl px-4 py-3 text-xl font-bold text-red-400 focus:border-red-400 focus:ring-2 focus:ring-red-400/30 focus:outline-none transition-all"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full bg-black/60 border-2 border-green-500/50 rounded-xl px-4 py-3 text-xl font-bold text-green-400 focus:border-green-400 focus:ring-2 focus:ring-green-400/30 focus:outline-none transition-all"
            />
          </div>
          <div>
          ...
          <div className="bg-black/40 p-4 rounded-xl border border-white/[0.08] flex flex-col justify-center">
      ...
      {statistics && (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          <div className="bg-black/60 p-5 rounded-2xl border border-white/[0.08] text-center flex flex-col justify-center min-h-[120px]">
      ...
      {/* CAGR Range Analysis */}
      {statistics && (
        <div className="bg-black/80 p-8 rounded-2xl border border-green-500 shadow-xl">
          <h4 className="text-2xl font-bold text-green-400 mb-6 text-center">{t('cagrTab.title')} ({yearsToAnalyze}Y)</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/40 p-6 rounded-xl text-center border border-red-700/50">
            ...
            <div className="bg-black/40 p-6 rounded-xl text-center border border-green-600/50">
            ...
            <div className="bg-black/40 p-6 rounded-xl text-center border border-green-700/50">
      ...
      {/* Chart */}
      {chartData && (
        <div className="bg-black/80 p-6 rounded-2xl border border-white/[0.06] shadow-xl">

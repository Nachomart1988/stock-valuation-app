    ...
    <div className="max-w-md w-full text-center">
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          {/* Features unlocked */}
          <div className="bg-gray-900/40 rounded-xl p-6 border border-white/[0.06]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/account"
              className="px-8 py-4 bg-gray-900/60 hover:bg-gray-900/50 text-white font-semibold rounded-xl transition"
            >
              Ver Mi Cuenta
            </Link>
          </div>

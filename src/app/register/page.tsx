              ...
              <>
                ...
                <form onSubmit={handleVerify} className="space-y-5">
                  ...
                  <input
                    ...
                    maxLength={6}
                    required
                    className="w-full px-4 py-3 bg-gray-800/50 border border-white/[0.06] rounded-xl text-white text-center text-2xl tracking-widest placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  />
                  <button
                    type="submit"
                    disabled={loading}

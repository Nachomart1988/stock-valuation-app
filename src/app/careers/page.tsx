      ...
      <main className="pt-28 pb-20 px-4 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-16">
          {[
            ...
            <div key={v.title} className="p-5 rounded-2xl bg-gray-900/50 border border-green-900/15">
        ...
        <div className="space-y-4 mb-16">
          {openings.map((role) => (
            <div key={role.title} className="p-6 rounded-2xl bg-gray-900/40 border border-green-900/15 hover:border-emerald-500/40 transition group">

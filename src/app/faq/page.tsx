  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-800 to-black text-white">
      ...
      <main className="pt-28 pb-20 px-4 max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          {sections.map((section) => (
            <div key={section.title}>
              ...
              <div className="bg-gray-900/60/40 rounded-2xl border border-green-900/15 px-6">
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gray-900/40 border border-green-900/15 text-center">
